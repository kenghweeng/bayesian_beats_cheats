...
def parse_results(df_combine=None, proba=None, true_labels=None):
    ...
    cf = confusion_matrix(df_combine.true_labels, y_pred)
    make_confusion_matrix(cf)

    plt.show()
    print()

    # Printing precision @ k
    prec_at_5 = get_prec_at_k(5, df_combine)
    prec_at_10 = get_prec_at_k(10, df_combine)
    prec_at_15 = get_prec_at_k(15, df_combine)
    print(f"Precision @ 5: {prec_at_5}")
    print(f"Precision @ 10: {prec_at_10}")
    print(f"Precision @ 15: {prec_at_15}")
